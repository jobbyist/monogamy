          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                Get a highly accurate monetary value estimation of any digital asset in less than 5 minutes. 
                Our AI-powered tool includes domain valuation and comprehensive market analysis.
              </p>
            </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mt-2">
                      Get an in-depth viability analysis with market research powered by Google Gemini's advanced 2.5 Pro AI model.
                    </p>
                  </div>
                </div>
              </div>
